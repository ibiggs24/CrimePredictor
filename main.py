...
def main():
    print("=== Crime Location Checker ===")
    address = input("Enter your address (include city and state): ").strip()
    ...
    print(f"Searching for nearby crimes within {distance} meters...\n")
